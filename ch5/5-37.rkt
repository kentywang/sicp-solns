...
;; Compare save/restore on every (non-empty) preserving call:
...
;; No stack is needed for this compiled code to run (+ 1 2 3), but the unoptimized
;; version uses it anyways, and it even double save/restores, further increasing
;; unefficacy.
