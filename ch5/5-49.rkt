...
;; A lot of leftover code, but it functions. Simple instruction set.
...
(define (assemble-eceval controller-text)
  (extract-labels controller-text
    (lambda (insts labels)
      (update-insts! insts labels eceval)
      insts)
    'NO-LABEL))
  ...
  (make-machine
    ...
    '(
      ...
      compile-code
        ...
        (assign val (op assemble-eceval) (reg val))
      execute-compiled
