...
(project (make-complex-from-real-imag 3 2)) ; 3
(project (cons 'real 0.33)) ; 1/3
(project (make-rational 2 3)) ; 1

(drop (make-complex-from-real-imag 3 2)) ; 3+2i
(drop (make-complex-from-real-imag 3 0)) ; (integer . 3)

(add (make-complex-from-real-imag 3 3)
     (make-complex-from-real-imag 2 -3)) ; (integer . 5)